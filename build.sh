...
echo "|"
echo "|       8. Network Restart - Partial invoke of network" 
echo "|           * Executes restartBuildUp, restartApp"
echo "|"
echo "|   ----------------------------------------------------"
echo "|"
...
while true; do
    ...
    case $opt in
        ...
        [8]* ) restartBuildUp && restartApp ; break;;
